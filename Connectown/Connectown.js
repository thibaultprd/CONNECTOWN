var Pacman = function(game, key) {
    ...
    this.sprite.animations.add('munchUp', [16, 17], 20, true);
    this.sprite.animations.add('munchDown', [14, 15], 20, true);
...
Pacman.prototype.move = function(direction) {
    ...
    {
        this.sprite.play('munchUp');
    }
    else if (direction === Phaser.DOWN)
    {
        this.sprite.play('munchDown');
    }

    this.current = direction;
};

Pacman.prototype.getDirection = function(pacman){
